...
export declare const SendClientMessage: (playerid: number, color: number, message: string) => number;
export declare const SendClientMessageToAll: (color: number, message: string) => number;
...
export declare const TextDrawColor: (text: number, color: number) => number;
export declare const TextDrawUseBox: (text: number, use: number) => number;
export declare const TextDrawBoxColor: (text: number, color: number) => number;
...
export declare const TextDrawBackgroundColor: (text: number, color: number) => number;
...
export declare const GangZoneShowForPlayer: (playerid: number, zone: number, color: number) => number;
export declare const GangZoneShowForAll: (zone: number, color: number) => number;
...
export declare const GangZoneFlashForPlayer: (playerid: number, zone: number, flashcolor: number) => number;
export declare const GangZoneFlashForAll: (zone: number, flashcolor: number) => number;
...
export declare const Create3DTextLabel: (text: string, color: number, X: number, Y: number, Z: number, DrawDistance: number, virtualworld: number, testLOS: number) => number;
...
export declare const Update3DTextLabelText: (id: number, color: number, text: string) => number;
export declare const CreatePlayer3DTextLabel: (playerid: number, text: string, color: number, X: number, Y: number, Z: number, DrawDistance: number, attachedplayer: number, attachedvehicle: number, testLOS: number) => number;
export declare const DeletePlayer3DTextLabel: (playerid: number, id: number) => number;
export declare const UpdatePlayer3DTextLabelText: (playerid: number, id: number, color: number, text: string) => number;
...
export declare const SetObjectMaterial: (objectid: number, materialindex: number, modelid: number, txdname: string, texturename: string, materialcolor: number) => number;
export declare const SetPlayerObjectMaterial: (playerid: number, objectid: number, materialindex: number, modelid: number, txdname: string, texturename: string, materialcolor: number) => number;
export declare const SetObjectMaterialText: (objectid: number, text: string, materialindex: number, materialsize: number, fontface: string, fontsize: number, bold: number, fontcolor: number, backcolor: number, textalignment: number) => number;
export declare const SetPlayerObjectMaterialText: (playerid: number, objectid: number, text: string, materialindex: number, materialsize: number, fontface: string, fontsize: number, bold: number, fontcolor: number, backcolor: number, textalignment: number) => number;
...
export declare const SetPlayerColor: (playerid: number, color: number) => number;
...
export declare const PlayerTextDrawColor: (playerid: number, text: number, color: number) => number;
export declare const PlayerTextDrawUseBox: (playerid: number, text: number, use: 0 | 1) => number;
export declare const PlayerTextDrawBoxColor: (playerid: number, text: number, color: number) => number;
...
export declare const PlayerTextDrawBackgroundColor: (playerid: number, text: number, color: number) => number;
...
export declare const SetPlayerChatBubble: (playerid: number, text: string, color: number, drawdistance: number, expiretime: number) => number;
...
export declare const SetPlayerMarkerForPlayer: (playerid: number, showplayerid: number, color: number) => number;
export declare const ShowPlayerNameTagForPlayer: (playerid: number, showplayerid: number, show: number) => number;
export declare const SetPlayerMapIcon: (playerid: number, iconid: number, x: number, y: number, z: number, markertype: number, color: number, style: number) => number;
...
export declare const SelectTextDraw: (playerid: number, hovercolor: number) => number;
