...
class DynamicObject {
    constructor(modelid, x, y, z, rotX, rotY, rotZ, closeDuration = 3, dd = 1000) {
        ...
        this.objectid = (0, SampFunctions_1.CreateObject)(modelid, x, y, z, rotX, rotY, rotZ, dd);
        return this;
    }
    ...
    destroy() {
        if (this.objectid !== null) {
            (0, SampFunctions_1.DestroyObject)(this.objectid);
            this.objectid = null;
        }
    }
    move() {
        ...
        (0, SampFunctions_1.MoveObject)(this.objectid, x, y, z, (this.state ? this.closeDuration : this.openDuration) || this.openDuration || this.closeDuration || 3, rotX, rotY, rotZ);
