...
export declare const OnPlayerEditObject: (func: (player: SampPlayer, playerobject: number, objectid: number, response: number, fX: number, fY: number, fZ: number, fRotX: number, fRotY: number, fRotZ: number) => void) => void;
export declare const OnPlayerEditAttachedObject: (func: (player: SampPlayer, response: number, index: number, modelid: number, boneid: number, fOffsetX: number, fOffsetY: number, fOffsetZ: number, fRotX: number, fRotY: number, fRotZ: number, fScaleX: number, fScaleY: number, fScaleZ: number) => void) => void;
...
export declare class SampEvents {
    ...
    static OnPlayerEditObject(func: (player: SampPlayer, playerobject: number, objectid: number, response: number, fX: number, fY: number, fZ: number, fRotX: number, fRotY: number, fRotZ: number) => void): void;
    static OnPlayerEditAttachedObject(func: (player: SampPlayer, response: number, index: number, modelid: number, boneid: number, fOffsetX: number, fOffsetY: number, fOffsetZ: number, fRotX: number, fRotY: number, fRotZ: number, fScaleX: number, fScaleY: number, fScaleZ: number) => void): void;
